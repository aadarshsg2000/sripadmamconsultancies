...
$address = "sripadmamgroup@gmail.com";
...
$e_body = "You have been contacted by $first_name. $first_name selected service of $select_service, their additional message is as follows. " . PHP_EOL . PHP_EOL;
